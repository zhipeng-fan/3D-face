...
class BFM_torch(nn.Module):
	...
	def __init__(self, BFM_MODEL):
		self.meanshape = torch.register_buffer("meanshape", BFM_MODEL.meanshape)
		self.idBase = torch.register_buffer("idBase", BFM_MODEL.idBase)
		self.exBase = torch.register_buffer("exBase", BFM_MODEL.exBase)
		self.meantex = torch.register_buffer("meantex", BFM_MODEL.meantex)
		self.texBase = torch.register_buffer('texBase', BFM_MODEL.texBase)
